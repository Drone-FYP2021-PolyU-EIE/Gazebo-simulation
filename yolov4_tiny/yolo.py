...
class YOLO(object):
    ...
    def detect_image(self, image):
        ...
        for i, c in enumerate(top_label):
            ...
            if predicted_class=="tree1_trunk":
            ...
            if predicted_class=="tree2_trunk":
    ...
    def detection_result(self):
        ...
        return oak_list_return, pine_list_return, tree1_list_return, tree2_list_return
